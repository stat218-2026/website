...
__Section 01:__ TWRF 09:10 AM – 10:00 AM 186-C200 (Constr Innovations Center 186)     
__Section 02:__ TWRF 10:10 AM – 11:00 AM 186-C200 (Constr Innovations Center 186)      
__Section 03:__ TWRF 12:10 PM – 01:00 PM 010-222 (Erhart Agriculture 010)    
...
quarter_dates <- c(ymd(20260606), seq(ymd(20260330), ymd(20260605), by=1))
class_wdays <- c("Tue", "Wed", "Thu", "Fri")

not_here_dates <- c(ymd(20260331), ymd(20260525))

exam_dates <- c(ymd(20260424), ymd(20260522), ymd(20260606))

finals_week <- seq(ymd(20260606), ymd(20260612), by = 1)

# Create a data frame of dates, assign to Cal
Cal <- tibble(date = seq(ymd(20260401), ymd(20260630), by=1))  |>
  ...
  mutate(category = case_when(
    ...
    quarter & wkdy %in% class_wdays & !not_here & !exam_wk | date == "2026-06-06" ~ "Class Day",
    TRUE ~ "NA")
  )
...
class_cal <- Cal |> 
  ...
  scale_fill_manual(values=c("Class Day" = "#154734", 
                             ...
                             "NA" = "white"),
                    breaks=c("Class Day", "Cal Poly Holiday", "Exam (In-Class)"))
class_cal
```
...
<div class="custom-table">
  ...
  <table>
    ...
    <tr>
      <td>Midterm 2 (Take Home + In-class)</td>
      <td>15%</td>
    </tr>
    <tr>
...
__Fri, April 24:__ Midterm I

__Fri, May 22:__ Midterm II 

__Sat, June 06:__ Final Exam (TBD)

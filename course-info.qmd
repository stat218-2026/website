...
__Section 04:__ MTWR 10:10 AM – 11:00 AM 2-212 (Cotchett Education 2)    
__Section 05:__ MTWR 12:10 PM – 01:00 PM 33-287 (Fisher Science 33)     
__Section 06:__ MTWR 01:10 PM – 02:00 PM 33-287 (Fisher Science 33)    
...
quarter_dates <- c(ymd(20260316), seq(ymd(20260105), ymd(20260312), by=1))
class_wdays <- c("Mon", "Tue", "Wed", "Thu")

not_here_dates <- c(ymd(20260119), ymd(20260216))

exam_dates <- c(ymd(20260129), ymd(20260305), ymd(20260316))

finals_week <- seq(ymd(20260316), ymd(20260320), by = 1)
...
Cal <- tibble(date = seq(ymd(20260101), ymd(20260331), by=1))  |>
  ...
  mutate(category = case_when(
    ...
    quarter & wkdy %in% class_wdays & !not_here & !exam_wk | date == "2026-03-16" ~ "Class Day",
    TRUE ~ "NA")
  )
...
__Thu, Jan 29:__ Midterm I

__Thu, Mar 05:__ Midterm II 

__Mon, Mar 16:__ Final Exam (7:15 PM)- BLDG 033-0286
